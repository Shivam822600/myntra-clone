    ...
    display: 'none',
      ...
      { const classes=useStyles();
        ...
        const handleClick=async()=>{
         ...
         var result=await postDataAndImage('accessory/interface',formData,config)
         if(result)
         {
          swal({
       ...
       <Grid container spacing={1}>
        ...
        <FormControl
         ...
         <Grid item xs={12}>
             <TextField onChange={(event)=> setaccessory(event.target.value)} label="Accessory" variant="outlined" fullWidth/>
              </Grid>
