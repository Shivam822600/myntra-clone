    ...
    display: 'none',
      ...
      { const classes=useStyles();
        ...
        const handleClick=async()=>{
         ...
         var result=await postDataAndImage('bestdeal/interface',formData,config)
         if(result)
         {
          swal({
       ...
       <Grid container spacing={1}>
        ...
        <FormControl
         ...
         <Grid item xs={12}>
             <TextField onChange={(event)=> setbestdeal(event.target.value)} label="Man Product" variant="outlined" fullWidth/>
              </Grid>
