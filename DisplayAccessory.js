...
<Grid item xs={12}>
 ...
 <Grid item xs={12}>
     <TextField value={accessory} onChange={(event)=> setaccessory(event.target.value)} label="Accessory Name" variant="outlined" fullWidth/>
      </Grid>
